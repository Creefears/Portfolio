/*
  ...
  1. Changes
    - Creates temporary function to migrate tools data from JSONB to junction table
    - Executes migration of existing tool data
    - Adds necessary policies for project_tools table
  
  2. Security
    - Adds public read access policy for project_tools
*/
...
-- Add policies for project_tools
DO $$ 
BEGIN
  IF NOT EXISTS (
